# Streamlit app code (save this as 'app.py')
import streamlit as st
import joblib
import numpy as np

# Load the saved model
model = joblib.load('D:\Jal Shakti\well_extraction_model.pkl')
...
# User input for each feature, without preset values
...
# Additional feature inputs based on original dataset (replace placeholders with actual feature names)
